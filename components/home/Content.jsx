        ...
        <>
            ...
            <SimpleGrid w={"auto"} h={"auto"} columns={[1, 1, 1]} mx={"auto"} spacingY={5} >
                ...
                <Box mx={"auto"} p={6} pos={"static"} rounded={"xl"} w={"auto"} maxH={"80%"}>
                    ...
                    <Image rounded={"xl"} mixBlendMode={"color-burn"}  mt={1} w={["60%","80%","70%"]} h={"auto"} maxH={"70%"} src='https://img.freepik.com/free-vector/astronaut-suit-illustration_114360-8538.jpg?w=826&t=st=1692213174~exp=1692213774~hmac=f25a5f88796116df4ec7b630b643bdd45a39de1ced64f560fc11395cdecf30d7' />
                </Box>
                {/* Fist Card *2 */}
                {/* bg={bg} */}
